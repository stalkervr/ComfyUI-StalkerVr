...
class LlamaPresetLoader:
    ...
    def load_preset(self, preset_file):
        ...
        full_path = os.path.join(presets_dir, preset_file)
        ...
        return (
            preset.get("max_tokens",defaults["max_tokens"]),
            preset.get("context_length",defaults["context_length"]),
            preset.get("gpu_layers",defaults["gpu_layers"]),
            preset.get("temperature",defaults["temperature"]),
            preset.get("top_p",defaults["top_p"]),
            preset.get("top_k",defaults["top_k"]),
            preset.get("min_p",defaults["min_p"]),
            preset.get("repeat_penalty",defaults["repeat_penalty"]),
            preset.get("presence_penalty",defaults["presence_penalty"]),
            preset.get("frequency_penalty", defaults["frequency_penalty"]),
        )